...
// (static/ergopti_plus/_shared/modules/llm/models.json) and exposes a compact
...
const MODELS_PATH = resolve(process.cwd(), 'static/ergopti_plus/_shared/modules/llm/models.json');
