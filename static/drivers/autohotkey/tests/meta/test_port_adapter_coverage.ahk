...
_MetaRunAdapterPresenceTests() {
	...
	RepoRoot := RegExReplace(RepoRoot, "/static/drivers/autohotkey/tests/meta$", "")

	SharedPorts := RepoRoot . "/static/drivers/_shared/ports"
	AhkAdapters := RepoRoot . "/static/drivers/autohotkey/adapters"
	HsAdapters  := RepoRoot . "/static/drivers/hammerspoon/adapters"
...
_MetaRunDomainCoverageTests() {
	...
	DomainDir  := RepoRoot . "/static/drivers/_shared/domain"
	AhkTests   := RepoRoot . "/static/drivers/autohotkey/tests"
	HsTests    := RepoRoot . "/static/drivers/hammerspoon/tests"
...
_MetaRunSharedPurityTests() {
	...
	SharedDir := RepoRoot . "/static/drivers/_shared"
