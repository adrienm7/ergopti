...
const translations = {
	ar: {
		...
		'karabiner.onboarding.error.manifest_unconfigured':
			'لم يتم تكوين الملف التعريفي (توجد عناصر نائبة TODO).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• الخدمة الخلفية غير قيد التشغيل (مراقبة الإدخال؟)',
	...
	cs: {
		...
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest není nakonfigurován (přítomny zástupné hodnoty TODO).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• Démon není spuštěn (Monitorování vstupu?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Systémové rozšíření (DriverKit) není aktivováno'
	},
	da: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements er ikke tilgængelig — kontroller installationen.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest er ikke konfigureret (TODO-pladsholdere er til stede).',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Systemudvidelsen (DriverKit) er ikke aktiveret'
	},
	de: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements nicht verfügbar — Installation überprüfen.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest nicht konfiguriert (TODO-Platzhalter vorhanden).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• Der Daemon läuft nicht (Eingabeüberwachung?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Die Systemerweiterung (DriverKit) ist nicht aktiviert'
	},
	en: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements unavailable — check installation.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest not configured (TODO placeholders present).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• The daemon is not running (Input Monitoring?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• The system extension (DriverKit) is not activated'
	},
	es: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements no disponible — verifique la instalación.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifiesto no configurado (hay marcadores TODO pendientes).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• El demonio no está en ejecución (¿Supervisión de entrada?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• La extensión del sistema (DriverKit) no está activada'
	},
	fr: {
		'karabiner.lifecycle.unavailable': "Karabiner-Elements indisponible — vérifiez l'installation.",
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest non configuré (des espaces réservés TODO sont présents).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			"• Le démon n'est pas en cours d'exécution (Surveillance des entrées ?)",
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			"• L'extension système (DriverKit) n'est pas activée"
	},
	he: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements אינו זמין — בדוק את ההתקנה.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'המניפסט אינו מוגדר (קיימים מציני מקום TODO).',
	...
	hi: {
		...
		'karabiner.onboarding.error.manifest_unconfigured':
			'मैनिफ़ेस्ट कॉन्फ़िगर नहीं है (TODO प्लेसहोल्डर मौजूद हैं)।',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• सिस्टम एक्सटेंशन (DriverKit) सक्रिय नहीं है'
	},
	it: {
		'karabiner.lifecycle.unavailable':
			"Karabiner-Elements non disponibile — verificare l'installazione.",
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest non configurato (sono presenti segnaposto TODO).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• Il daemon non è in esecuzione (Monitoraggio input?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			"• L'estensione di sistema (DriverKit) non è attivata"
	},
	ja: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements が利用できません — インストールを確認してください。',
		'karabiner.onboarding.error.manifest_unconfigured':
			'マニフェストが設定されていません（TODO プレースホルダーが存在します）。',
		...
		'karabiner.onboarding.missing.ke_not_installed':
			'• Karabiner-Elements がインストールされていません',
		'karabiner.onboarding.missing.sysext_not_activated':
			'• システム拡張（DriverKit）が有効化されていません'
	},
	ko: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements를 사용할 수 없습니다 — 설치를 확인하세요.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'매니페스트가 구성되지 않았습니다 (TODO 자리 표시자가 있음).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• 데몬이 실행되고 있지 않습니다 (입력 모니터링?)',
		'karabiner.onboarding.missing.grabber_absent': '• karabiner_grabber 데몬이 없습니다',
		'karabiner.onboarding.missing.ke_not_installed':
			'• Karabiner-Elements가 설치되어 있지 않습니다',
		'karabiner.onboarding.missing.sysext_not_activated':
			'• 시스템 확장 프로그램(DriverKit)이 활성화되지 않았습니다'
	},
	nl: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements niet beschikbaar — controleer de installatie.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest niet geconfigureerd (TODO-plaatshouders aanwezig).',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• De systeemextensie (DriverKit) is niet geactiveerd'
	},
	no: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements er ikke tilgjengelig — sjekk installasjonen.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest er ikke konfigurert (TODO-plassholdere er til stede).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• Daemonen kjører ikke (Inndataovervåking?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Systemutvidelsen (DriverKit) er ikke aktivert'
	},
	pl: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements niedostępny — sprawdź instalację.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest nie jest skonfigurowany (obecne są symbole zastępcze TODO).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• Demon nie jest uruchomiony (Monitorowanie wejścia?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Rozszerzenie systemowe (DriverKit) nie jest aktywowane'
	},
	pt: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements indisponível — verifique a instalação.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifesto não configurado (marcadores TODO presentes).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• O daemon não está em execução (Monitoramento de entrada?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• A extensão do sistema (DriverKit) não está ativada'
	},
	ru: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements недоступен — проверьте установку.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Манифест не настроен (присутствуют заглушки TODO).',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Системное расширение (DriverKit) не активировано'
	},
	sv: {
		'karabiner.lifecycle.unavailable':
			'Karabiner-Elements är inte tillgängligt — kontrollera installationen.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifestet är inte konfigurerat (TODO-platshållare finns).',
		...
		'karabiner.onboarding.missing.daemon_not_running':
			'• Demonen körs inte (Inmatningsövervakning?)',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Systemtillägget (DriverKit) är inte aktiverat'
	},
	tr: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements kullanılamıyor — kurulumu kontrol edin.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Manifest yapılandırılmamış (TODO yer tutucuları mevcut).',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Sistem uzantısı (DriverKit) etkinleştirilmemiş'
	},
	uk: {
		'karabiner.lifecycle.unavailable': 'Karabiner-Elements недоступний — перевірте встановлення.',
		'karabiner.onboarding.error.manifest_unconfigured':
			'Маніфест не налаштований (присутні заглушки TODO).',
		...
		'karabiner.onboarding.missing.sysext_not_activated':
			'• Системне розширення (DriverKit) не активовано'
	},
	zh: {
...
for (const file of files) {
	...
	console.log(
		`OK    ${file} — ${Object.keys(newKeys).length} key(s) injected, ${Object.keys(sorted).length} total key(s)`
	);
}
