...
-- Selected by a declaration unique to modules/karabiner/config.lua rather than by
-- path, so moving or splitting the module cannot turn this invariant
-- into a path error.
local src = helpers.read_driver_source("local function append_shared_modifier_chords")
helpers.assert_true(src ~= nil, "modules/karabiner/config.lua source must be locatable")
