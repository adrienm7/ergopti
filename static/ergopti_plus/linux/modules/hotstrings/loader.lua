...
--- in static/ergopti_plus/_shared/modules/hotstrings/schema.md. Implements a lightweight
--- line-by-line parser — no external TOML library is required — capable of
--- handling the [[entry]] array format used throughout _shared/modules/hotstrings/.
---
--- FEATURES & RATIONALE:
