...
<section>
	...
	<p>
		...
		<kbd-output>ª</kbd-output> étaient auparavant sur la touche <kbd>0</kbd>. Ils ont été déplacés
	...
	<p>
		...
		du script dans la barre des taches.
	</p>
	<p>
	...
	<p>
		Cependant, cette modification était importante à réaliser, car le <kbd>C</kbd> est désormais
		...
		même doigt que le <kbd>D</kbd>, ce qui permet de taper la commande <kbd-output>cd</kbd-output>
		(change directory) sans <SFB></SFB>.
	</p>
	<p>
	...
	<br />
	<p>
		Ce changement n’a pas été pris à la légère, celui-ci faisant bouger 8 touches. Il n’améliore en
		plus même pas le taux de <SFB></SFB>s, car les touches assignées à chaque doigt restent les
		mêmes. C’est vraiment une interversion de confort pour taper des bigrammes.
	</p>
	<p>
		Elle demeure une évolution souhaitable, car le bigramme <kbd>TH</kbd> est <b>de loin</b> le plus
		fréquent en anglais. <kbd>ND</kbd> est lui aussi extrêmement fréquent, en particulier en
		anglais, et prend la place de <kbd>NC</kbd> dont la fréquence d’apparition est en comparaison minime.
	</p>
	<p>
		La raison pour laquelle le <kbd>TH</kbd> est beaucoup plus confortable avec la version 2.0 est
		...
		touche
		<kbd>★</kbd> a été placée sur l’index gauche en rangée du bas et non du haut : car cette position
		est la plus confortable.
	</p>
	<p>
		Le <kbd>L</kbd>, très fréquent en français mais moins en anglais, est donc sur une touche un peu
		moins accessible. Cela permet au <kbd>H</kbd>, une lettre à la fréquence extrêmement forte en
		anglais et fréquence moyenne-faible en français, d’être plus accessible.
	</p>
	<br />
	<p>
		En résumé, la version 2.0 d’<Ergopti></Ergopti> conserve ses excellents scores en alternance des
		mains, distance parcourue, minimisation des <SFB></SFB>s, etc. Toutefois, elle
