...
_WritePathsToml(NewDir) {
	...
	try {
		...
		f.Write("# Custom paths — auto-generated by ErgoptiPlus.`n")
		f.Write("# Edit this file to point to your personal configuration folder.`n")
		f.Write("# If absent or commented out, files are looked up in: " . DefaultDirFwd . "`n")
		f.Write("`n")
		f.Write('ConfigDirPath = "' . NewDirFwd . '"`n')
		f.Close()
		FileMove(TmpPath, _PathsFile, true)
		return true
	} catch as err {
		try f.Close()
		try FileDelete(TmpPath)
