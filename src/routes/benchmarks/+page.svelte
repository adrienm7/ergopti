...
<p>
	...
	touches moindre, car les pouces seront beaucoup plus mis à contribution. De plus, il y aura moins
	de SFBs, car Shift, Enter, etc. ne seront plus sur les auriculaires mais les pouces.
</p>
<mini-espace />
<p>
...
<mini-espace />
<p>
	En conclusion, comparer des dispositions n’est pas aussi simple qu’on pourrait le penser. Comparez
	avec le même type de clavier et avec exactement les mêmes caractères sur les touches. En outre, la
	philosophie derrière la construction du clavier doit être prise en compte. En effet, certaines
	dispositions comme Optimot préfèrent mettre l’apostrophe droite en accès direct plutôt que celle
	typographique, partant du principe que la plupart des éditeurs de texte remplaceront de toute
	manière par l’apostrophe typographique. Dans ce cas précis, le caractère faisant office
	d’"apostrophe" est l’apostrophe droite, alors que d’autres dispositions comme <Nom /> fait la distinction
	entre les deux. Pour comparer avec le plus d’exactitude les dispositions, il faudrait modifier l’une
	des dispositions pour soit remplacer l’apostrophe typographique par une apostrophe droite, soit ajoutant
	une apostrophe typographique dans la disposition n’en ayant pas.
</p>
<p class="text-bold">
...
<p>
	...
	scores. Il serait aussi possible de faire cela pour les majuscules : il paraît évident que la majuscule
	d’une lettre soit en Shift + Lettre. Pourtant, il serait tout à fait possible que cela ne soit pas
	le cas, mais cela impliquerait alors d’apprendre deux fois plus de choses : où sont les lettren, et
	où sont les majuscules. Tout cela pour peu de gains si ce n’est avoir un score légèrement supérieur
