 ...
 *
 * ROOT CAUSE 4 — THREE PACKAGE COLUMNS PRETENDED TO COVER SIX MANAGERS.
...
// plus every _install_<name> helper that probes `command -v <name>` (a command
// installed by its own function rather than by the generic helper).
