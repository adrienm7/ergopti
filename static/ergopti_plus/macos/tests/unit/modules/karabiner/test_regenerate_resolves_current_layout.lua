--- tests/unit/modules/karabiner/test_regenerate_resolves_current_layout.lua
...
helpers.describe("karabiner.regenerate: resolves against the live layout", function()
	...
	helpers.it("re-resolves the action table before building the config", function()
		-- Selected by a declaration unique to modules/karabiner/init.lua rather than
		...
		helpers.assert_true(regen_at ~= nil, "modules/karabiner/init.lua must define M.regenerate()")
