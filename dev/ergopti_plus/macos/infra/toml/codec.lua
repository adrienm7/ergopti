--- infra/toml/codec.lua

--- ==============================================================================
--- MODULE: TOML Codec — macOS shim
--- DESCRIPTION:
--- Re-exports the canonical TOML codec from the shared Lua library.
--- Callers: require("infra.toml.codec"). The real implementation lives at:
---   static/ergopti_plus/_shared/lua/toml_codec/codec.lua
---
--- RATIONALE:
--- The codec was extracted to _shared/ so all Lua-based drivers (Hammerspoon,
