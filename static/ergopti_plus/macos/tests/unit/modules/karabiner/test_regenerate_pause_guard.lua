--- tests/unit/modules/karabiner/test_regenerate_pause_guard.lua
...
local function load_karabiner(paused)
	...
	package.loaded["modules.karabiner.generator"] = {
	...
	local K = helpers.load_with_stubs("modules.karabiner", {
		keycodes = {
