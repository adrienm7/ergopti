...
<p>
	...
	sont <kbd-output>à</kbd-output>, <kbd-output>là</kbd-output> et <kbd-output>déjà</kbd-output>. Par
	conséquent, toute combinaison de type <kbd>às</kbd> ou <kbd>àc</kbd> n’est jamais tapée. Cela donne
