; static/ergopti_plus/windows/tests/test_llm_menu_persistence.ahk

; ==============================================================================
; MODULE: LLM Menu Persistence Tests
; DESCRIPTION:
; Guards the tray IA menu against config regressions (menu change not written
; to config.toml on reload). Driven by shared/llm/menu_persistence_contract.json.
;
...
; Schema + static wiring (any OS): python ../../shared/llm/validate_menu_persistence_contract.py
; ==============================================================================
...
_LLM_Persist_ContractPath() {
	return A_ScriptDir . "\..\..\shared\llm\menu_persistence_contract.json"
}
