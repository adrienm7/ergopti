...
const CHECKS = [
	...
	{ name: 'Linux feature parity status (324 rows with explicit ownership and proof tiers)', cmd: 'node', args: ['tools/test/test-linux-feature-parity.cjs'], repro: 'npm run test:linux-feature-parity' },
