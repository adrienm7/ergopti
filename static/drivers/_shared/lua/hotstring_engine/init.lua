...
---   static/drivers/_shared/domain/HotstringMatcher.spec.js
---
--- FEATURES & RATIONALE:
...
-- Hammerspoon environment), map every level to a plain print so the rest of the
-- code never needs nil-guards around Logger calls.
