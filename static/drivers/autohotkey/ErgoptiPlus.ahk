...
; TOML reader helpers (UnescapeTomlString, LoadHotstringsSection,
; FoldAsciiLower, ApplyTomlMetadataToFeatures) extracted into a dedicated
; submodule so the main file stays focused on ErgoptiPlus-specific logic.
