...
<section>
	...
	<p>
		...
		droite du clavier, taper dessus, puis retourner à la souris pour continuer la navigation.
	</p>
	<p>
	...
	<p>
		...
		envoie un raccourci, mais la presser la fait se comporter normalement. Cela permet d’intégrer
		des touches
