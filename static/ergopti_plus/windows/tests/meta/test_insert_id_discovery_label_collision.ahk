...
_IIDLC_InsertResolvesByPositionFirst() {
	...
	Seg := _IIDLC_FuncBody(Src, "RegisterMenuItemInsert(MenuObj, BeforeItem, ItemName, Callback) {")
...
_IIDLC_UniqueFinderRejectsCollisions() {
	Src := _IIDLC_ReadSource("lib/menu_dispatcher.ahk")
	Seg := _IIDLC_FuncBody(Src, "_FindUniqueMenuItemIdByName(MenuObj, ItemName) {")
