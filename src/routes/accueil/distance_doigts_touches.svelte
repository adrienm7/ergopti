...
<section>
	...
	<p>
		...
		parfois atteindre la rangée supérieure ou inférieure pour les lettres les moins fréquentes.
	</p>
	...
	<p>
		Pourtant, le QWERTY est pire qu’une disposition aléatoire sur ce point. La légende raconte que
		sa première rangée remonte à l’époque de l’invention de la machine à écrire. Le choix de la
	...
	<p>
		...
		la rangée du dessus (<kbd>AZERTYUIOP</kbd>). C’est notamment le cas de toutes les voyelles, dont
		le nombre est faible comparé au nombre de consonnes, mais qui sont toutefois incontournables
		pour l’écriture de chaque mot.
	</p>
	...
	<p>
		...
		<kbd>S</kbd>, <kbd>N</kbd>, <kbd>T</kbd> et <kbd>R</kbd>. <Ergopti /> place ainsi les lettres les
	...
	<p>
		...
		bien sur la rangée du milieu en <Ergopti />. Effectivement, la lettre la plus fréquente, le
