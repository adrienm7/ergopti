...
--- in static/drivers/_shared/logger/test_vectors.json. Every vector describes an
...
-- static/drivers/hammerspoon/ and static/drivers/_shared/ are siblings, so
-- _shared/ is one level up from the driver root.
local SHARED_VECTORS_PATH = helpers.driver_root() .. "../_shared/logger/test_vectors.json"
