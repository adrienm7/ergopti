; static/ergopti_plus/windows/lib/hotstrings/generated_distancesreduction.ahk
...
; ``_GENERATED_HOTSTRINGS`` map entries for the ``distancesreduction`` category.
...
global _GENERATED_HOTSTRINGS_DISTANCESREDUCTION := Map(
	"distancesreduction.comma_far_letters", _GenLoad_distancesreduction_comma_far_letters,
	"distancesreduction.comma_j", _GenLoad_distancesreduction_comma_j,
	"distancesreduction.dead_key_e_circumflex", _GenLoad_distancesreduction_dead_key_e_circumflex,
	"distancesreduction.e_circumflex_e", _GenLoad_distancesreduction_e_circumflex_e,
	"distancesreduction.qu", _GenLoad_distancesreduction_qu,
	"distancesreduction.suffixes_a", _GenLoad_distancesreduction_suffixes_a,
)
...
_GenLoad_distancesreduction_comma_far_letters(FeatureConfig, ExtraOptions := unset) {
	...
	_GenOpts := Map("TimeActivationSeconds", _GenTimeAct, "FinalResult", false, "IsRepeat", false, "Category", "distancesreduction", "Section", "comma_far_letters")
...
_GenLoad_distancesreduction_comma_j(FeatureConfig, ExtraOptions := unset) {
	global ScriptInformation
	_GenTimeAct := FeatureConfig.HasOwnProp("TimeActivationSeconds") ? FeatureConfig.TimeActivationSeconds : 0
	_GenMK := ScriptInformation["MagicKey"]
	_GenOpts := Map("TimeActivationSeconds", _GenTimeAct, "FinalResult", false, "IsRepeat", false, "Category", "distancesreduction", "Section", "comma_j")
	if IsSet(ExtraOptions) and ExtraOptions.Has("OnlyText") {
		_GenOpts["OnlyText"] := ExtraOptions["OnlyText"]
	}
...
_GenLoad_distancesreduction_dead_key_e_circumflex(FeatureConfig, ExtraOptions := unset) {
	global ScriptInformation
	_GenTimeAct := FeatureConfig.HasOwnProp("TimeActivationSeconds") ? FeatureConfig.TimeActivationSeconds : 0
	_GenMK := ScriptInformation["MagicKey"]
	_GenOpts := Map("TimeActivationSeconds", _GenTimeAct, "FinalResult", false, "IsRepeat", false, "Category", "distancesreduction", "Section", "dead_key_e_circumflex")
	if IsSet(ExtraOptions) and ExtraOptions.Has("OnlyText") {
		_GenOpts["OnlyText"] := ExtraOptions["OnlyText"]
	}
...
_GenLoad_distancesreduction_e_circumflex_e(FeatureConfig, ExtraOptions := unset) {
	global ScriptInformation
	_GenTimeAct := FeatureConfig.HasOwnProp("TimeActivationSeconds") ? FeatureConfig.TimeActivationSeconds : 0
	_GenMK := ScriptInformation["MagicKey"]
	_GenOpts := Map("TimeActivationSeconds", _GenTimeAct, "FinalResult", false, "IsRepeat", false, "Category", "distancesreduction", "Section", "e_circumflex_e")
	if IsSet(ExtraOptions) and ExtraOptions.Has("OnlyText") {
		_GenOpts["OnlyText"] := ExtraOptions["OnlyText"]
	}
...
_GenLoad_distancesreduction_qu(FeatureConfig, ExtraOptions := unset) {
	...
	_GenTimeAct := FeatureConfig.HasOwnProp("TimeActivationSeconds") ? FeatureConfig.TimeActivationSeconds : 0
	_GenMK := ScriptInformation["MagicKey"]
	_GenOpts := Map("TimeActivationSeconds", _GenTimeAct, "FinalResult", false, "IsRepeat", false, "Category", "distancesreduction", "Section", "qu")
	if IsSet(ExtraOptions) and ExtraOptions.Has("OnlyText") {
		_GenOpts["OnlyText"] := ExtraOptions["OnlyText"]
	}
...
_GenLoad_distancesreduction_suffixes_a(FeatureConfig, ExtraOptions := unset) {
	global ScriptInformation
	_GenTimeAct := FeatureConfig.HasOwnProp("TimeActivationSeconds") ? FeatureConfig.TimeActivationSeconds : 0
	_GenMK := ScriptInformation["MagicKey"]
	_GenOpts := Map("TimeActivationSeconds", _GenTimeAct, "FinalResult", false, "IsRepeat", false, "Category", "distancesreduction", "Section", "suffixes_a")
	if IsSet(ExtraOptions) and ExtraOptions.Has("OnlyText") {
		_GenOpts["OnlyText"] := ExtraOptions["OnlyText"]
	}
