...
--- section-LESS `package.loaded["lib.i18n"] = { get = ... }` at module scope, and a
...
helpers.describe("load_with_stubs isolates menu modules from a leaked i18n stub", function()
	helpers.it("clears cached ui.menu.* and restores a section-capable lib.i18n stub", function()
		...
		package.loaded["lib.i18n"] = { get = function(k) return k end }   -- NO section/decorate_section
		package.loaded["ui.menu.menu_karabiner"] = "STALE_CONTAMINATED"
		...
		helpers.assert_nil(package.loaded["ui.menu.menu_karabiner"])
		helpers.assert_nil(package.loaded["ui.menu.menu_utils"])
		helpers.assert_eq(type(package.loaded["lib.i18n"].section), "function")
		helpers.assert_eq(type(package.loaded["lib.i18n"].decorate_section), "function")
	end)
end)
