...
--- 2. Seamless Injections: Inserts predictions securely without ghost typing.
--- ==============================================================================
...
-- Connects the separated UI module inputs back into the engine
...
function M.handle_llm_keys(keyCode, flags, is_ignored)
    ...
    -- Numeric validation logic (Fallback redundancy for tooltip interception)
    ...
    -- Note: Tab interception & Arrow Navigation has been moved entirely into ui/tooltip.lua
    -- to prevent event fall-through and macOS system key bleed.
