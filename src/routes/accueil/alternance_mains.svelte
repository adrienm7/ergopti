...
<section>
	...
	<p>
		...
		de l’AZERTY, puis le <kbd>R</kbd>, pour écrire <kbd>CR</kbd>, un bigramme très courant en
		français et anglais. Dans ce cas, vous devez d’abord légèrement abaisser votre main pour que le
		majeur atteigne la rangée du bas pour taper
		<kbd>C</kbd>. Puis, il faut que l’index atteigne quant à lui la rangée du haut pour taper
		<kbd>R</kbd>. En résulte un sentiment d’inconfort avec deux doigts proches mais qui doivent
