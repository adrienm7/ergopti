...
const CHECKS = [
	...
	{ name: 'changelog Markdown safety (pinned SRI assets + sanitizer-before-innerHTML)', cmd: 'node', args: ['tools/test/test-changelog-markdown-safety.cjs'], repro: 'npm run test:changelog-markdown-safety' },
