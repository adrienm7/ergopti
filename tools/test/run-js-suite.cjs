...
const CHECKS = [
	...
	{ name: 'no new unexplained platform restriction (I2 ratchet — 142 today; run with --report for the inventory)', cmd: 'node', args: ['tools/test/test-platform-restrictions-explained.cjs'], repro: 'node tools/test/test-platform-restrictions-explained.cjs --report' },
