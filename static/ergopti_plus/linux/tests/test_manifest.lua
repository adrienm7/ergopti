...
return {
	...
	"tests.unit.infra.test_unicode_case",
	"tests.unit.infra.test_script_settings",
	"tests.unit.infra.test_xkb_rmlvo",
	...
	"tests.unit.meta.test_keyboard_hook_tap_hold",
	...
	"tests.unit.meta.test_shared_hotstring_languages",
