...
- [x] **Bloc 2 — Perf frappe** 🟢 : sortir les sous-process/IO bloquants du thread d entrée
  ...
  - [x] #76-#78 low — aece71450 — HookDispatcher reverse-index, HSE star-guards, engine buffer once-per-keystroke
...
- [x] **Bloc 5 — Tests** 🟢 : remplacer les no-op (#38/#39), rejouer le moteur partagé contre le
  ...
  - [x] #57 rejouer moteur hotstring Windows contre le corpus — 444897734 — test_corpus_hotstrings.ahk §5 (18 vectors + collision replay)
