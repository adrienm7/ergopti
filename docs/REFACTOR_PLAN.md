...
- [ ] Sortir l'UI de `lib/` → `ui/<window>/` (onboarding, changelog, hotstrings_config_window, hotstring_editor, model_browser, wpm, ~~healthcheck~~ ✅, spotlight). `tooltip` ✅ (déjà sorti vers `ui/tooltip/`).
