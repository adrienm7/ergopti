...
<ul class="margin-top-2">
	...
	<p>
		La lettre <kbd-sortie>K</kbd-sortie> est rarement utilisée. Lorsqu’elle l’est, c’est souvent
		pour réaliser les combinaisons <kbd-sortie>SK</kbd-sortie> et <kbd-sortie>CK</kbd-sortie>.
		Ainsi, ces roulements permettent d’éviter d’aller appuyer sur la vraie touche <kbd>K</kbd> pour une
		frappe beaucoup plus confortable.
	</p>
</ul>
