...
--- The tunable numbers live in ``static/drivers/_shared/llm/inference.json``
...
local function load_inference_constants()
	local candidates = {
		...
		hs.configdir .. "/../../static/drivers/_shared/llm/inference.json",
		(os.getenv("HOME") or "") .. "/Library/Application Support/Hammerspoon/../../../static/drivers/_shared/llm/inference.json",
	}
