import{a as y,f as C}from"../chunks/BwQyXKxJ.js";import"../chunks/ZMhDjBdn.js";import{ar as e,ap as s,aq as t,as as a,an as se,e as te,am as ae,bb as ne}from"../chunks/BfxWfEpd.js";import{E as n,a as ie,d as re,h as oe}from"../chunks/CuDmgE8d.js";import{E as S,P as ue}from"../chunks/Dpwnzdg8.js";import{s as Y}from"../chunks/C9X8Jd6g.js";import{S as u}from"../chunks/D_S7o6hb.js";const le=!0,Se=Object.freeze(Object.defineProperty({__proto__:null,prerender:le},Symbol.toStringTag,{value:"Module"}));var de=C('<section class="main"><h1 data-aos="zoom-in">Informations sur la disposition <!></h1> <hr class="margin-h1"/></section>');function pe(p){var i=de(),r=s(i),o=e(s(r));n(o),t(r),a(2),t(i),y(p,i)}var ce=C(`<section><h2>Autocritiques</h2> <h3>L’importance des compromis</h3> <p>Il est évident qu’il n’est pas possible de maximiser plusieurs paramètres simultanément. Bien
		...
		pas la disposition la plus adaptée si vous écrivez dans une langue différente du français et de l’anglais.</p></section>`,2);function me(p){var i=ce(),r=e(s(i),4),o=e(s(r));n(o),a(),t(r);var l=e(r,4),m=e(s(l));u(m);var c=e(m,4);u(c),a(9),t(l);var d=e(l,2),k=e(s(d));n(k),a(),t(d);var E=e(d,4),U=e(s(E),6),f=e(s(U),3);n(f);var D=e(f,2);S(D);var G=e(D,8);u(G),a(3),t(U),t(E);var L=e(E,4),A=e(s(L));n(A);var w=e(A,14);Y(w,1,"deadkey");var H=e(w,8);Y(H,1,"deadkey"),a(),t(L);var h=e(L,2),O=e(s(h));n(O);var I=e(O,2);n(I),a(3),t(h);var g=e(h,2),B=e(s(g));u(B),a(),t(g);var j=e(g,2),z=s(j),b=e(s(z),2);u(b);var V=e(b,2);u(V);var $=e(V,6),N=e($,2),P=e(N,2);e(P,2),a(),t(z),a(4),t(j);var W=e(j,2),v=e(s(W),2);u(v);var R=e(v,2);S(R);var M=e(R,2);u(M),a(2),t(W);var q=e(W,4),_=s(q),T=e(s(_),2);u(T);var Z=e(T,4);e(Z,2),a(),t(_),t(q);var x=e(q,6),K=e(s(x),5);S(K),a(11),t(x);var F=e(x,4),X=s(F);n(X),a(),t(F);var J=e(F,2),Q=e(s(J));n(Q);var ee=e(Q,2);n(ee),a(),t(J),t(i),y(p,i)}var be=C(`<section><h2 id="changelog">Changelog</h2> <h3>Version 2.2.1 (Janvier 2026)</h3> <ul><li>Correction de l’inversion des caractères <kbd-output>-</kbd-output> et <kbd-output>_</kbd-output> sur la touche <kbd-output>◌̈</kbd-output>.</li> <li>Ajout des caractères <kbd>í</kbd> et <kbd>Í</kbd> manquants. Cet ajout permute les positions
		...
		stable suite à tous ces essais.</p></section>`,2);function ve(p){var i=be(),r=e(s(i),4),o=s(r),l=e(s(o)),m=e(l,2),c=e(m,2);Y(c,1,"deadkey"),a(),t(o);var d=e(o,2),k=e(s(d),19),E=e(k,2);Y(E,1,"deadkey");var U=e(E,2);Y(U,1,"deadkey"),a(),t(d);var f=e(d,4),D=e(s(f));S(D),a(),t(f),a(2),t(r);var G=e(r,4),L=e(s(G));n(L);var A=e(L,10);e(A,2),a(),t(G);var w=e(G,4),H=e(w,4),h=e(H,2),O=e(s(h));S(O),a(),t(h);var I=e(h,2),g=e(s(I));n(g),a(),t(I);var B=e(I,4),j=s(B);n(j);var z=e(j,6);u(z),a(5),t(B);var b=e(B,2),V=e(s(b),9),$=e(V,2);u($),a(),t(b);var N=e(b,2),P=e(s(N));u(P);var W=e(P,2);u(W),a(5),t(N);var v=e(N,4),R=s(v);n(R),a(3),t(v);var M=e(v,8),q=e(s(M));u(q),a(),t(M);var _=e(M,10),T=e(s(_));n(T);var Z=e(T,2);u(Z),a(3),t(_);var x=e(_,4),K=s(x);n(K),a(),t(x),t(i),y(p,i)}var ke=C('<section><h2>Contact</h2> <div class="encadre"><p class="text-center margin0">Le créateur de la disposition <!> et de ce site est <strong>Adrien MOYAUX</strong>.</p> <p>Vous pouvez créer une nouvelle <em>Issue</em> sur <a href="https://github.com/adrienm7/ergopti" target="_blank" class="link">la page GitHub du projet</a> si vous avez une question ou un problème, notamment pour l’installation.</p> <p class="margin0">Il est aussi possible de rejoindre le <a class="link">serveur Discord BÉPO | Ergodis</a> où <!> dispose d’un canal dédié, simplifiant les échanges.</p></div></section>');function fe(p){var i=ke(),r=e(s(i),2),o=s(r),l=e(s(o));n(l),a(3),t(o);var m=e(o,4),c=e(s(m)),d=e(c,2);n(d),a(),t(m),t(r),t(i),se(()=>ie(c,"href",re)),y(p,i)}var he=C(`<section><h2 class="first-h2">Genèse et inspirations</h2> <p>La genèse de la disposition <!> remonte à début 2022, suite à la découverte de la
		...
		Les avoir en roulement offre un confort exceptionnel.</p></section>`,2);function ge(p){var i=he(),r=e(s(i),2),o=e(s(r));n(o);var l=e(o,6);u(l),a(),t(r);var m=e(r,4),c=e(m,4),d=e(s(c));n(d),a(13),t(c);var k=e(c,2),E=e(s(k),9);n(E),a(3),t(k);var U=e(k,2),f=e(U,4),D=e(s(f));n(D);var G=e(D,4);n(G),a(),t(f);var L=e(f,2),A=e(L,4),w=e(s(A),3);n(w),a(5),t(A);var H=e(A,4),h=e(s(H),2);n(h),a(),t(H);var O=e(H,4),I=e(s(O));n(I),a(),t(O);var g=e(O,2),B=e(s(g),9);n(B),a(),t(g);var j=e(g,2),z=e(j,6),b=e(z,2),V=e(s(b),2);u(V),a(),t(b);var $=e(b,6),N=s($);n(N),a(5),t($);var P=e($,4),W=e(s(P));S(W),t(P);var v=e(P,2),R=e(s(v));n(R);var M=e(R,2);S(M),a(),t(v);var q=e(v,2),_=e(s(q));S(_);var T=e(_,2);u(T);var Z=e(T,6);u(Z),a(),t(q);var x=e(q,2),K=e(s(x));n(K),a(3),t(x),a(2),t(i),y(p,i)}var qe=C(`<section><h2 id="licence">Licence</h2> <p>La disposition de clavier <!>, ses pilotes ainsi que son site de présentation <a href="https://ergopti.fr" class="link">https://ergopti.fr</a> sont distribués sous la <strong>licence MIT</strong>. Le code source est librement disponible
		...
		conserver les mentions de licence et de droits d'auteur.</p> <h3>Permissions</h3> <ul><li>Utilisation commerciale ;</li> <li>Modification ;</li> <li>Distribution ;</li> <li>Usage privé.</li></ul> <h3>Limitations</h3> <ul><li>Absence de garantie ;</li> <li>Aucune responsabilité.</li></ul> <h3>Conditions</h3> <ul><li>Conservation des mentions de licence et des droits d'auteur.</li></ul></section>`);function _e(p){var i=qe(),r=e(s(i),2),o=e(s(r));n(o),a(7),t(r),a(14),t(i),y(p,i)}var xe=C('<meta name="description" content="Informations sur la disposition Ergopti"/>'),ye=C("<!> <!> <!> <!> <!>",1),Ce=C("<bloc-introduction><!></bloc-introduction>",2);function De(p){oe("9tyz0s",i=>{var r=xe();te(()=>{ne.title="Informations"}),y(i,r)}),ue(p,{children:(i,r)=>{var o=ye(),l=ae(o);ge(l);var m=e(l,2);me(m);var c=e(m,2);ve(c);var d=e(c,2);_e(d);var k=e(d,2);fe(k),y(i,o)},$$slots:{default:!0,introduction:(i,r)=>{var o=Ce(),l=s(o);pe(l),t(o),y(i,o)}}})}export{De as component,Se as universal};
