...
<section>
	...
	<p>
		...
		<span class="text-gray"
			...
			rendre compte en pressant fort de l’index sur une table, puis en essayant de faire de même
			avec votre auriculaire.</span
		>
	</p>
	<p>
	...
	<p>
		Enfin, contrairement au BÉPO ou à l’Optimot, <Nom /> ne place pas de symboles de programmation ou
