; tests/test_ollama_curl_temp_pii_plaintext.ahk
...
;     LLM_OllamaGenerate_Streaming build their temp paths from the hardened-dir
;     helper, not a bare A_Temp join, so the hardening can never regress.
; ==============================================================================
