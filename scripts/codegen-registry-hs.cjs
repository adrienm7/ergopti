...
// Generates static/drivers/hammerspoon/_generated/registry.lua from
...
function generate() {
	...
	L("--- Source: static/drivers/_shared/domain/registry.spec.js");
	...
	const STAR_UTF8 = "★";
	L(`\tlocal star_base       = trigger:match("^(.-)" .. string.char(0xE2, 0x98, 0x85) .. "?$") or trigger`);
