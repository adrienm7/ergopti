...
<section>
	...
	<div class="content">
		<p>
			La touche morte <kbd>^</kbd> est très loin sur un clavier standard. La majorité du temps, elle
			est utilisée pour écrire <kbd>Ê</kbd>, qui est une touche déjà présente sur l’annulaire
