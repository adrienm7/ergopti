...
const CHECKS = [
	...
	{ name: 'every declared menu row has a handler in its driver (I3 ratchet — ahk 0, hs 16, linux 10)', cmd: 'node', args: ['tools/test/test-menu-action-handler-bijection.cjs'], repro: 'node tools/test/test-menu-action-handler-bijection.cjs' },
