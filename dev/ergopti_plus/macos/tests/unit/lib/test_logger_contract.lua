...
--- in static/ergopti_plus/_shared/modules/logger/test_vectors.json. Every vector describes an
...
---
--- RATIONALE:
--- The _shared/modules/logger/SPEC.md defines a single line format used by both AHK and HS:
...
local SHARED_VECTORS_PATH = helpers.shared("modules/logger/test_vectors.json")
