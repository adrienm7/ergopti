...
<section>
	...
	<ul>
		...
		<p>
			De plus, ajouter cette fonctionnalité sur la touche <kbd>"Capslock"</kbd> (qui a été remappée
			en BackSpace) est un choix plutôt logique. Ainsi, tous les raccourcis de suppression sont à
			cet emplacement, car la touche <kbd-sortie>Suppr.</kbd-sortie> est quant à elle disponible en
			<kbd>Shift</kbd>
			+ <kbd>"Capslock"</kbd>.
		</p>
		<!-- <li>
