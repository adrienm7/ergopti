...
<p>
	...
	dispositions peut engendrer des très bonnes performances chez elles, ceci car la touche <kbd
		>★</kbd
	> ne sera pas parmi leurs touches et sera donc systématiquement ignorée, améliorant sensiblement leurs
	stats.
</p>
<p>
...
<image-block>
	<enhanced:img
		src="$lib/images/benchmarks/plus/ergopti+_reduction_SFBs.jpg"
...
<p>
	...
	disposition. Ainsi, l’utilisation d’<ErgoptiPlus></ErgoptiPlus> divise par environ 8 le nombre de <SFB
	></SFB>s d’<Ergopti></Ergopti>.
</p>
<p>Voici une vue plus détaillée (attention, les axes des ordonnées ne sont pas les mêmes) :</p>
<h4><Ergopti></Ergopti></h4>
<image-block>
	<enhanced:img
		src="$lib/images/benchmarks/plus/SFBs_ergopti.jpg"
		alt="SFBs de la disposition Ergopti"
	/>
</image-block>
<h4><ErgoptiPlus></ErgoptiPlus></h4>
<image-block>
	<enhanced:img
		src="$lib/images/benchmarks/plus/SFBs_ergopti+.jpg"
		alt="SFBs de la disposition Ergopti+"
...
<p>
	...
	<kbd>★.</kbd>, même s’ils sont déjà deux fois moins nombreux qu’avec <ErgoptiPlus></ErgoptiPlus>.
	Il y a sans doute possiblité d’améliorer cela, c’est un point à l’étude. En dehors de cela, les
...
<p>
	...
	le corpus normal, nous avions 50 306 touches tapées par <Ergopti></Ergopti>. Ce nombre tombe à 45
	525 touches tapées avec <ErgoptiPlus></ErgoptiPlus>. Le gain de 10% s’explique probablement
	surtout par les raccourcis de suffixes en
	<kbd>À</kbd>.
</p>
<p>
	...
	raccourcis de <ErgoptiPlus></ErgoptiPlus>).
</p>
<p>
...
<image-block>
	<enhanced:img
		src="$lib/images/benchmarks/plus/finger_usage_comparison.jpg"
...
<p>
	...
	avec <ErgoptiPlus></ErgoptiPlus>. Cela vient des nombreuses utilisations de la touche
