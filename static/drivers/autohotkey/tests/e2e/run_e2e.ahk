; static/drivers/autohotkey/tests/e2e/run_e2e.ahk
...
; static/drivers/_shared/tests/corpus/hotstrings/vectors.json (the same
...
; from static/drivers/_shared/tests/corpus/hotstrings/vectors.json.
