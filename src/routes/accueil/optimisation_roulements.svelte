...
<section>
	...
	<p>
		Un roulement consiste à frapper deux touches avec la même main, sans que cela n’entraîne de <SFB
		></SFB> ni de <em>ciseau</em>. Généralement, la frappe est tellement rapide que la première
		touche n’est pas encore relâchée que le seconde est déjà pressée. Cela donne une impression très
		agréable de "rouler" sur les touches.
	</p>
	<p>
		Cependant, tous les roulement ne se valent pas. Les meilleurs sont ceux sur deux doigts
		...
		ce n’est pas le <kbd>CE</kbd> de l’AZERTY ni le
		<kbd>GL</kbd> du BÉPO.
	</p>
	<p class="encadre">
		...
		sur deux doigts consécutifs dans un mouvement horizontal.
	</p>

	<tiny-space></tiny-space>

	<p>Les roulements d’<Ergopti></Ergopti> sont visibles sur le clavier ci-dessous :</p>
	...
	<ul>
		<li><kbd>AI</kbd> ;</li>
		<li><kbd>AU</kbd> ;</li>
		<li><kbd>EU</kbd> et <kbd>UE</kbd> ;</li>
		<li><kbd>ÉE</kbd> ;</li>
	...
	<ul>
		<li>
			<kbd>AIE</kbd> : notamment pour écrire <strong>AIE</strong>NT (avec en plus <kbd>NT</kbd> qui est
			lui aussi un roulement, que demander de plus ?) ;
		</li>
		<li><kbd>IEU</kbd> ;</li>
		<li><kbd>OUI</kbd> ;</li>
		<li><kbd>YOU</kbd>.</li>
	...
	<ul>
		<li>
			<kbd>CH</kbd> : <strong>ce bigramme est extraordinaire</strong>, une fois habitué il est
		...
		<li><kbd>GR</kbd> ;</li>
		<li>
			<kbd>LD</kbd> : fréquent en anglais (O<strong>LD</strong>, COU<strong>LD</strong>, SHOU<strong
				>LD</strong
			>, WOU<strong>LD</strong>, etc.) ;
		</li>
		<li><kbd>NC</kbd> ;</li>
		<li>
			<kbd>ND</kbd> : extrêmement fréquent, notamment pour tous les A<strong>ND</strong> en anglais ;
		</li>
		<li><kbd>NG</kbd> : pour tous les -I<strong>NG</strong> en anglais ;</li>
		<li><kbd>NS</kbd> et <kbd>SN</kbd> ;</li>
		<li>
			<kbd>NT</kbd> : c’est le
			<strong>bigramme consonne-consonne le plus fréquent en français</strong> ;
		</li>
		<li><kbd>PL</kbd> ;</li>
		<li><kbd>RS</kbd> ;</li>
		<li><kbd>SH</kbd> ;</li>
		<li>
			<kbd>TH</kbd> : c’est le <strong>bigramme le plus fréquent, et de loin, en anglais</strong> et
			il est ultra-confortable ;
		</li>
	...
	<ul>
		<li><kbd>NTR</kbd> ;</li>
		<li>
			<kbd>GHT</kbd> : très fréquent en anglais pour tous les -OU<strong>GHT</strong> et -I<strong
				>GHT</strong
			> ;
		</li>
	</ul>
