...
helpers.describe("gestures.actions: get_label", function()
	helpers.it("returns the French label for an axis id", function()
		helpers.assert_eq(Actions.get_label("tabs"),    "Onglets")
		helpers.assert_eq(Actions.get_label("volume"),  "Volume")
		helpers.assert_eq(Actions.get_label("windows"), "Fenêtres")
	end)

	helpers.it("returns the French label for a single id", function()
		helpers.assert_eq(Actions.get_label("mute"),       "Muet/Unmute")
		helpers.assert_eq(Actions.get_label("track_play"), "Lecture/Pause")
		helpers.assert_eq(Actions.get_label("lookup"),     "Définition du mot")
	end)

	helpers.it("returns 'Désactivé' for nil and 'none'", function()
		helpers.assert_eq(Actions.get_label(nil),    "Désactivé")
		helpers.assert_eq(Actions.get_label("none"), "Désactivé")
	end)
...
helpers.describe("gestures.actions: is_scalable", function()
	...
	helpers.it("does NOT flag tabs / tracks / spaces / document / line_bounds as scalable", function()
		...
		helpers.assert_true(not Actions.is_scalable("tabs"))
