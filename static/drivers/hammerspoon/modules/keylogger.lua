...
--- 11. Privacy Filters: Automatically ignores user-defined excluded applications, private browsing windows, and password fields (AXSecureTextFields).
...
local function handle_key(event_obj)
    ...
    local ok, err = pcall(function()
        ...
        -- ============================================
        -- ===== 6.1) Privacy & Exclusion Filters =====
        -- ============================================

        -- Note: Password fields (AXSecureTextField) are filtered dynamically below
