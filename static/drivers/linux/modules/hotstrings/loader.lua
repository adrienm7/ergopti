--- static/drivers/linux/modules/hotstrings/loader.lua

--- ==============================================================================
--- MODULE: Hotstring TOML Loader (Linux)
--- DESCRIPTION:
--- Loads hotstring definitions from TOML files that follow the schema defined
--- in static/drivers/_shared/hotstrings/schema.md. Implements a lightweight
...
-- Reuse the same fallback pattern as engine.lua so the module is usable both
-- inside Hammerspoon and as a standalone daemon component.
