...
helpers.describe("linux/lib/locale.lua", function()
	helpers.it("module loads without error", function()
		local ok, mod = pcall(require, "lib.locale")
		helpers.assert_true(ok, "require('lib.locale') should succeed")
...
helpers.describe("linux/lib/i18n.lua", function()
	helpers.it("module loads without error", function()
		local ok, mod = pcall(require, "lib.i18n")
		helpers.assert_true(ok, "require('lib.i18n') should succeed")
		helpers.assert_true(type(mod) == "table", "should return a table")
	end)
