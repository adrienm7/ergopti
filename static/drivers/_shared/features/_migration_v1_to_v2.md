...
| Hardcoded tap-hold defaults (AHK) | [`lib/tap_hold_config.ahk`](../../autohotkey/lib/tap_hold_config.ahk) | `config/ergopti_plus/ahk/tap_hold.toml` (per-driver file, generated from [`_shared/tap_hold/defaults.toml`](../tap_hold/defaults.toml) at first boot) |
