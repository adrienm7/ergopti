...
<section>
	...
	<ul>
		...
		<li>
			...
			en anglais avec les combinaisons <kbd-output>SK</kbd-output>,
			<kbd-output>CK</kbd-output>, etc. Sur un clavier Ergodox, ce problème s’atténue, en
			particulier sur les claviers concaves de type Kinesis Advantage ou Glove80.
		</li>
		<li>
			Les touches <kbd>Q</kbd> et <kbd>Z</kbd> pourraient aussi être critiquées, car elles
	...
	<p>
		...
		></ErgoptiPlus> utilisant beaucoup la touche <kbd>À</kbd>, il convenait de la mettre sous un
	...
	<p>
		...
		pour une utilisation très rare.
	</p>
	<p>
		En outre, <Ergopti></Ergopti> a été optimisée pour le français et l’anglais ; elle n’a pas été pensée
		pour être utilisée dans d’autres langues. Par conséquent, <Ergopti></Ergopti> n’est probablement
		pas la disposition la plus adaptée si vous écrivez dans une langue différente du français et de l’anglais.
	</p>
</section>
