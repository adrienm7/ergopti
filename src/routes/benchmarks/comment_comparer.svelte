...
<section>
	...
	<p>
		...
		faisant office d’"apostrophe" est l’apostrophe droite, alors que d’autres dispositions comme une
		version précédente d’<Nom /> font la distinction entre les deux.
	</p>
	<p>
