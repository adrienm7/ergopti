...
- [ ] `HS-003` — terminal delivery transaction and global ordering fence; implementation lenses found nine material blockers
...
**Implementation replay — still open.** The candidate closes several earlier ordering cases, but independent implementation lenses found nine material blockers. None is checked until the real production path and exact native contracts are behaviorally replayed:
