// scripts/codegen-expander-ahk.cjs
...
function buildAhkSource() {
	...
	lines.push('\t\tlocal termConsumed := (opts.Has("terminator_consumed") && opts["terminator_consumed"])');
	...
	lines.push("\t\t; The caller is responsible for the replacement length; here we supply trigger length");
