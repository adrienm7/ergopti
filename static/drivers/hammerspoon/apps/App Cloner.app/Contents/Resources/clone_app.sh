...
# package, so "from WebKit import ..." raises ImportError at runtime. Using
# objc.loadBundle() + lookUpClass() bypasses the Python package entirely and
# binds directly to the Objective-C classes from the system framework.
try:
    objc.loadBundle(
        "WebKit",
