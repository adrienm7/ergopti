...
<div class="accordion">
	<section>
		...
		<label for="acc21">
			...
			<h3 data-aos="zoom-out" data-aos-mirror="true">[QU] automatiques avant les voyelles</h3>
		</label>
		<div class="content">
			<p>
	...
	<section>
		...
		<label for="acc22">
			<span class="numero-faq" />
			<h3 data-aos="zoom-out" data-aos-mirror="true">[OÙ]</h3>
		</label>
		<div class="content">
			<p>
				La touche <kbd>Ù</kbd> n’est utilisée que pour écrire <kbd>OÙ</kbd>. Ainsi, autant
				tranformer cette touche en raccourci pour écrire <kbd-sortie>OÙ</kbd-sortie> pour économiser
	...
	<section>
		...
		<label for="acc23">
			...
			<h3 data-aos="zoom-out" data-aos-mirror="true">
				Utilisation de la touche <kbd>À</kbd> : en tant que J
			</h3>
		</label>
		<div class="content">
			<p>
				La touche <kbd>J</kbd> est très loin et pourtant relativement souvent utilisée en français,
				en particulier pour écrire <kbd>JE</kbd>. Les combinaisons <kbd-non>ÀI</kbd-non>,
				...
				opportunité d’utiliser cette touche comme un <kbd-sortie>J</kbd-sortie>, si elle est suivie
				d’une voyelle.
			</p>
			<p>
				Dans les rares cas où vous voudrez écrire <kbd>J</kbd> + <kbd>Consonne</kbd>, il faudra
				utiliser la vraie touche <kbd-sortie>J</kbd-sortie>. De même si vous voulez utiliser un
				raccourci avec
	...
	<section>
		...
		<div class="content">
			<p>
				La touche morte <kbd>^</kbd> est très loin sur un clavier standard. La majorité du temps,
				elle est utilisée pour écrire <kbd>Ê</kbd>, qui est une touche déjà présente sur l’annulaire
				gauche. Toutefois, dans de rares cas, il est nécessaire d’écrire <kbd>Â</kbd>, <kbd>Î</kbd>,
				<kbd>Ô</kbd>
				ou encore
	...
	<section>
		<input type="checkbox" name="acc" id="acc25" />
		<label for="acc25">
			<span class="numero-faq" />
			<h3 data-aos="zoom-out" data-aos-mirror="true">
		...
		<div class="content">
			...
			<p>
				Un autre raccourci a été ajouté pour avoir la possibilité d’écrire <kbd-sortie
					>N'T</kbd-sortie
				>
				par un roulement. Effectivement, <kbd>NT’</kbd> se transforme en
				<kbd-sortie>N'T</kbd-sortie> pour pouvoir faire [majeur, annulaire, auriculaire] plutôt que [majeur,
