// static/ergopti_plus/_shared/ports/TooltipRenderer.spec.js
 ...
 * (_shared/tooltip/draw_calls.js) and translates it to native drawing calls.
 *
 * FEATURES & RATIONALE:
 ...
 *    arithmetic is done inside the adapter — that lives in _shared/tooltip/.
...
const portContract = {
	 ...
	 *                     (see _shared/tooltip/draw_calls.js).
