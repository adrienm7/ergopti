...
<section>
	...
	<div class="content">
		...
		<p>
			Comme vous pouvez le constater, la touche <kbd>,</kbd> est vraiment pour supprimer les
			derniers petits <SFB />s restants. La disposition <Nom /> éliminait déjà la majorité d’entre eux.
		</p>
	</div>
	...
	<div class="content">
		...
		<p>
			...
			sous l’index gauche. Une fois qu’on y est habitué, la frappe devient encore un peu plus rapide
			et efficace, car même les lettres doublées peuvent être parallélisées. Et ce n’est pas sa seule
			fonction…
		</p>
	</div>
</section>
