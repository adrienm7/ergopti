...
;
; KL_AsyncPasswordDetect ran on a one-shot timer (a separate pseudo-thread from
; the keystroke reader) and wrote the per-HWND password cache in three
