...
<ul class="margin-top-2">
	...
	<p>
		...
		des abréviations telles que <em>QMK</em>, <em>ASCII</em>, <em>FAQ</em>, etc. De plus, elle
		permet également d’écrire plus aisément les noms des variables et constantes en programmation
