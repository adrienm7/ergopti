...
<p>
	...
	jamais à plus d’une rangée d’écart. Il y peu d’informations sur le sujet en ligne ; un roulement a
	...
	l’annulaire par exemple.
</p>
<p>
	En conclusion, un roulement est pour moi le <kbd>PO</kbd> de l’AZERTY ou le <kbd>ST</kbd> du BÉPO
	(idéalement, car mouvement horizontal). Sinon, c’est éventuellement le <kbd>PL</kbd> de l’AZERTY
	ou le <kbd>LS</kbd> du BÉPO. Toutefois, ce n’est pas le <kbd>ST</kbd> de l’AZERTY ni le
	<kbd>GL</kbd> du BÉPO.
</p>
<p>
