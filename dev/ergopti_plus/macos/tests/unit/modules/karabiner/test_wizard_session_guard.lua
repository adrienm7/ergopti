--- tests/unit/modules/karabiner/test_wizard_session_guard.lua

--- ==============================================================================
--- MODULE: modules.karabiner — first-run wizard session guard regression
--- DESCRIPTION:
...
helpers.describe("karabiner.init — wizard session guard", function()
	helpers.it("declares _wizard_ran_this_session module-level flag", function()
		local src = read_source("modules.karabiner.init")
		helpers.assert_true(
			src:find("_wizard_ran_this_session", 1, true) ~= nil,
			"modules.karabiner.init must declare `_wizard_ran_this_session` to prevent the " ..
	...
	helpers.it("wizard timer is conditional on `not _wizard_ran_this_session`", function()
		...
		helpers.assert_true(
			...
			"modules.karabiner.init: the wizard timer must be guarded by " ..
