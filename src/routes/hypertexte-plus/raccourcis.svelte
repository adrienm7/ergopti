...
<ul>
	...
	<p>
		...
		cette touche sur la touche <kbd>"Alt"</kbd> la ramène à un endroit extrêmement accessible. Cela
		supprime aussi beaucoup de <SFB />s.
	</p>
	<p>
		Le layer de navigation contient quant à lui les flèches directionnelles pour naviguer rapidement
		dans un texte, mais aussi toutes les combinaisons de ces flèches avec des modificateurs. Ainsi,
		il y a des raccourcis <kbd>Ctrl</kbd> + <kbd>Flèche</kbd>,
		<kbd>Ctrl</kbd>
		+
		<kbd>Shift</kbd>
		+
	...
	<p>
		À noter que les raccourcis comme <kbd>Ctrl</kbd> + <kbd>Entrée</kbd> par exemple sont également
		fonctionnels avec cette autre touche <kbd>Entrée</kbd>.
	</p>
	<li>
