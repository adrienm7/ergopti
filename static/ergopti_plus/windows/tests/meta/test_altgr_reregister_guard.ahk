...
; brace flush-left at column 0 (AHK functions close with `}` at column 0, inner
; blocks close indented). Returns "" when the declaration is absent.
_AGRG_FuncBody(Src, FuncDef) {
