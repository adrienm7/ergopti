...
-- Climb from hammerspoon/ root up to repo root (static/drivers/hammerspoon -> repo)
...
helpers.describe("meta: port-adapter coverage", function()
	local shared_ports = REPO_ROOT .. "/static/drivers/_shared/ports"
	local ahk_adapters = REPO_ROOT .. "/static/drivers/autohotkey/adapters"
	local hs_adapters  = REPO_ROOT .. "/static/drivers/hammerspoon/adapters"
...
helpers.describe("meta: domain spec test coverage", function()
	local domain_dir = REPO_ROOT .. "/static/drivers/_shared/domain"
	local ahk_tests  = REPO_ROOT .. "/static/drivers/autohotkey/tests"
	local hs_tests   = REPO_ROOT .. "/static/drivers/hammerspoon/tests"
...
helpers.describe("meta: _shared/ code purity", function()
	local shared_dir = REPO_ROOT .. "/static/drivers/_shared"
