...
<section>
	...
	<p>
		Notamment, le <kbd>E</kbd> n’est pas sur l’index de la rangée de repos. Ce qui est pourtant
		étrange, tant son apparition est fréquente dans les textes. C’est la lettre la plus fréquente et
		de loin. Pourtant, elle ne se trouve pas sur l’index notamment afin de réduire les <SFB />s. Si
...
<section>
	...
	<p>
		...
		de distance aux touches, le <kbd>E</kbd> serait logiquement sur l’index, voire le pouce. Or,
		avoir cela engendrera beaucoup plus de <SFB />s, ce qui rendra impossible la maximisation de ce
		seconde critère.
	</p>
	<p>
