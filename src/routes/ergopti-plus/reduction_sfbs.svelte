...
<section>
	...
	<p>
		...
		<kbd-output>people</kbd-output>, etc.) Tous ces <SFB />s sont supprimés avec <ErgoptiPlus />,
		plus de nombreux autres encore plus rares.
	</p>
	...
	<p>
		La touche <kbd>,</kbd> est l’une des plus importantes d’<ErgoptiPlus />. C’est grâce à elle que
	...
	<h3>Utilisation des touches <kbd>É</kbd>, <kbd>È</kbd> et <kbd>Ê</kbd></h3>
	<p>
		Les touches <kbd>É</kbd> , <kbd>È</kbd> et <kbd>Ê</kbd> permettent de se débarrasser des
		quelques <SFB />s se trouvant sur la main gauche. Plus particulièrement, ce sont les <SFB />s
		sur les touches
		<kbd>I</kbd>, <kbd>E</kbd> ainsi qu’en <kbd>U</kbd> :
	</p>
	<ul class="margin-top-2">
		<li>
			<kbd>êe</kbd> ➜ <kbd-output>œ</kbd-output> ;
		</li>
		<li>
			<kbd>êé</kbd> ➜ <kbd-output>oe</kbd-output> ;
		</li>
		<li>
			<kbd>éê</kbd> ➜ <kbd-output>eo</kbd-output> ;
		</li>
		<li>
		...
		<li>
			<kbd>èy</kbd> ➜ <kbd-output>aî</kbd-output> ;
		</li>
		<li>
			<kbd>yè</kbd> ➜ <kbd-output>â</kbd-output>.
		</li>
		<tiny-space></tiny-space>
		<li>
			<kbd>éà</kbd> ➜ <kbd-output>ié</kbd-output> ;
		</li>
		<li>
			<kbd>àé</kbd> ➜ <kbd-output>éi</kbd-output>.
		</li>
	</ul>
	...
	<h3>Touche <kbd class="glow">★</kbd> de répétition</h3>
	<p>
		De nombreux <SFB />s se produisent non pas à cause de deux touches devant être tapées par le
		même doigt, mais lors de la répétition de la même touche. C’est par exemple le cas avec
	...
	<tiny-space></tiny-space>
	<p>
		La touche <kbd class="glow">★</kbd> est <strong>l’ajout principal</strong>
	...
	<p>
		La nouvelle touche <kbd class="glow">★</kbd>
		<strong>va répéter la dernière touche tapée</strong>. Ainsi,
	...
	<p>
		L’utilisation de la touche <kbd class="glow">★</kbd> va instantanément fluidifier la fra<kbd
			>p★</kbd
		>e et réduire le nombre de <SFB />s. Une fois qu’on y est habitué, l’écriture au clavier devient
